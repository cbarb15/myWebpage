    ...
    <div class=\"container\">
        ...
        echo"
            ...
            <ol class='breadcrumb'>
                ...
                <li class='active'>Student Login/Registration</li>
            </ol>
  ...
  <div class=\"jumbotron\">
    <h1>Student Login/Registration</h1>";
        ...
        if(isset($_SESSION['role']))
            echo"
        <a href='Student_Login.php' onclick=\"return validateStudentEntry('$role')\"><button class='btn btn-lg btn-default btn-block' style='font-size: x-large; height: 100px; text-align: center; text-decoration: none'>Login/Student Form List</button></a>";
        else
            echo"
           <a href='Student_Login.php'><button class='btn btn-lg btn-default btn-block' style='font-size: x-large; height: 100px; text-align: center; text-decoration: none'>Login/Student Form List</button></a>";
